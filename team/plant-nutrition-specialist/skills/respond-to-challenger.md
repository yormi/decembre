...
1. `team/plant-nutrition-specialist/from-model-challenger.md` — open requests
2. `team/plant-nutrition-specialist/from-model-challenger-done.md` — check for `### Challenger verdict — FAIL` returns (bounced back, need redo)
