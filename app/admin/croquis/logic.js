...
function croquisSuggestedLayout() {
  ...
  return [
    ...
    table(62, 52),
    rack(76, 74, 90, 2), rack(104, 74, 90, 2),
    rack(76, 122, 90, 1), rack(104, 122, 90, 1),
    rack(76, 170, 90, 1), rack(104, 170, 90, 1),
    table(62, 218),
    rack(20, 276, 90, 1), rack(48, 276, 90, 1), rack(94, 276, 90, 1), rack(122, 276, 90, 2), rack(167, 276, 90, 1),
  ];
}
