...
//
// Spec table enumerates 4 source-of-truth bindings the Bilan supply
// function must reference: computeStageRecipe(stage), STORED_RECIPE.tomato
// .sidedress[stage], BIOMASS_DEMAND[stage], TOMATO_FRUIT_EXPORT[el].
// Source-grep pairs the consumer (app/index.html) + runtime check that
// calculateNutritionSupply produces non-trivial output. (Foliaire binding
// retired 2026-07-18 — foliar block removed; the channel is read internally
// by computeFoliarSupply, not by the bilan directly.)
