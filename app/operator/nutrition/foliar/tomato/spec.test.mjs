...
// app/operator/nutrition/foliar/tomato/user-stories.md against the rendered DOM.
//
// SLUG coverage:
...
import { loadFoliarFixture } from '../../../../../nutrition/tomato/domain/foliar/model/test-helpers.mjs';
