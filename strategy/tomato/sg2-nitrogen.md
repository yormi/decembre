...
- Why lead, not adjunct: two edges feather meal lacks — (1)
  ...
  *all* uptake. So Ocean delivers usable N the impaired root
  ...
  (peat-trial transfer). Full mechanism: `nutrition/tomato/domain/learnings/0002-interim-root-uptake-levers-during-ph-wait.md`.
...
- **Do NOT scale Ocean for tissue N** — amino-N is a ~10–20%
  ...
  `nutrition/tomato/domain/learnings/0003-ocean-amino-n-ceiling-not-a-bulk-n-source.md`.
...
- Lever: FarinePlumes granular. Role = slow-release N drip over
  ...
  2 950 mg N/m²/wk (offtake − compost; `nutrition/tomato/domain/sidedress/derivation.md`).
...
- ~~Fresh SME to split N supply-tight vs uptake-impaired~~ —
  **resolved** by the 2026-06-04 SME: uptake-limited
  (`nutrition/tomato/domain/learnings/0003-n-reclassified-supply-tight-to-uptake-only.md`).
