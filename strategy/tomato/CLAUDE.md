# strategy/tomato — farm-level tomato nutrition strategy

Farm-level nutrition strategy framing — above the
per-subproject spec tree. What's *binding*, what we're aiming
for, in what order.
...
The root-level `problem.md` / `goal.md` / `sg*.md` / `protocol/` are the **tomato** yield-recovery strategy. Per-crop strategies that need their own kernel live in a subdir:
