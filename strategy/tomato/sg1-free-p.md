...
- Model + dosing: `nutrition/tomato/domain/soil-ph/derivation.md`.
...
- Endpoint: target band 6.0–6.5, aim 6.3, hard floor 5.8
  ...
  `nutrition/tomato/domain/soil-ph/learnings/define-soil-root-zone-ph-target-band.md`).
...
- Raises **tissue** P, **NOT** soil available P — does not
  ...
  Mechanism + rating (4/5): `nutrition/tomato/domain/learnings/0002-interim-root-uptake-levers-during-ph-wait.md`.
