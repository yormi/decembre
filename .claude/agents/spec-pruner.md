...
One of: `nutrition/tomato/domain/plant-needs/`, `fertigation-recipe/`, `foliar-strategy/`, `sidedress-recipe/`, `app/`, `nutrition/nursery/<sub>/`, `nutrition/lettuce/<sub>/`, `nutrition/compost-contribution/`, `nutrition/soil-contribution/`, `yield-range/`, `yield-range/app/`, etc.
