...
What gets pruned (UI / calc-model-data / derivation), the candidate format, the 6-phase per-subproject walk, and spec-gap / STORED-recipe-drift surfacing — all live in `team-coordination/spec-pruner/procedures/prune-subproject.md`. Trigger it once Guillaume names a subproject.
