...
2026-06-14. Adopted `measure-bed-ec-DRAFT.md` (1:1 soil:water by weight, read with a Bluelab EC pen) as the canonical bed-salinity method, and dropped the in-soil Bluelab Pulse as an absolute measure.
