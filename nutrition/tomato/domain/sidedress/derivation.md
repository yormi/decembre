...
`app/index.html`, nutrition/tomato — luxury-feeding-guard governed by `nutrition/tomato/domain/spec.md`):
...
- **2026-05-23 refit — FarinePlumes.eff 0.75 → 0.70.** Single-cohort
  ...
  Full trace in `nutrition/tomato/domain/doc/tomato-t5-tissue-analysis-2026-05-23.md`.
