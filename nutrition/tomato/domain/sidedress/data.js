...
//
// Spec:        nutrition/tomato/domain/sidedress/spec.md
// Derivation:  nutrition/tomato/domain/sidedress/derivation.md
//
...
//
//   N = SIDEDRESS_PRODUCTS.FarinePlumes.efficiency = 0.70 (cert 3 —
//       Sonneveld mineralization rate for warm-greenhouse organic-N;
//       70-85% range from feather-meal literature → 0.70 floor after
//       2026-05-22 TOM #1 T5 tissue refit; tissue N 2.27 % vs floor
//       3.10 % indicated 0.75 mid-band was optimistic. Cohort n=1;
