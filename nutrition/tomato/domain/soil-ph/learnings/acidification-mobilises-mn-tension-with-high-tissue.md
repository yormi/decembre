# Lowering soil pH mobilises Mn — tension with already-high T5 tissue Mn

**Date:** 2026-05-30
**Status:** accepted — real cost of the sulphur programme; not a blocker, a monitored trade-off

The sulphur pH-drawdown is sold on its wins: unlock the locked P vault
(Mehlich 557 kg/ha) + lift pH-suppressed Fe/Mn/Zn root uptake. But Mn
is the **cost side** of that same lever, and on this crop it collides
with a live tissue finding.
...
- The 2026-05-30 T5 panel confirmed **real tissue Mn over-supply**
  ...
  acidification. The P-unlock goal and the Mn status pull opposite ways.
- Zn: same mechanism, smaller magnitude. Fe + P are the clean wins.

Magnitude of the Mn rise on *this* soil is cert 2 (the pH–Mn solubility
law is cert 4; the soil's Mn pool + buffering aren't measured).
...
Cross-ref: `derivation.md` § guardrails (floor 6.2),
`nutrition/tomato/domain/doc/tomato-t5-tissue-analysis-2026-05-23.md`
(tissue Mn over-supply), `what-the-ph-lever-actually-addresses-per-t5-tissue`.
