...
`nutrition/tomato/domain/foliar/CONTEXT.md`).
...
Same scale as `nutrition/tomato/domain/plant-needs/spec.md` ("Cert scale" —
canonical).
...
- **`nutrition/tomato/domain/plant-needs/model — plant-needs-tomato-namespace`** — `PlantNeedsTomato.demandTotal` is canonical demand source.
