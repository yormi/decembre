...
- **FarinePlumes 0.75 (N) — cert 3.** Sonneveld & Voogt 2009 reports
  ...
  delivers steady-state. Cert capped at 3 (not 4) because the high-end
  pick within the literature band is a defensible reading but not the
  only one — a lower-end 0.70 reading would also fit.
