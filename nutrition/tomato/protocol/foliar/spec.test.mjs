// Tests for nutrition/tomato/protocol/foliar/user-stories.md.
//
// SLUG coverage (4):
...
// nutrition/tomato/domain/foliar/model/test-helpers.mjs — same jsdom
...
import { loadFoliarFixture } from '../../domain/foliar/model/test-helpers.mjs';
