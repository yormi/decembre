...
**Live overshoot (June 2026):** SME CE **4.01** — ~3× the ECe 1.3 guardrail (report 39580). The salt is saline, not sodic (SAR 1.29) → **leach before the next pass, don't pause the program** (`../../../protocol/salt-leach-DRAFT.md`). Full read: `../learnings/field-sme-salinity-climbed-2026-06.md`. The pre-transplant EC check is currently a hard gate, not a formality. (SME pH also fell 7.48 → 6.68 — sulphur drawdown; secondary guardrail, not a re-anchor of the dose model.)
