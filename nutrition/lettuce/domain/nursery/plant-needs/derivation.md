...
| File                                          | Owns                                                              |
|-----------------------------------------------|-------------------------------------------------------------------|
| `nutrition/lettuce/domain/nursery/plant-needs/data.js`       | `LETTUCE_NURSERY_TISSUE_DW`, `LETTUCE_NURSERY_DM_FRACTION`, `NURSERY_TARGETS` |
| `nutrition/lettuce/domain/nursery/plant-needs/calc.js`       | `calcNurseryDemand`                                               |
| `nutrition/lettuce/domain/nursery/plant-needs/model.js`      | `window.PlantNeedsNursery` namespace                              |
