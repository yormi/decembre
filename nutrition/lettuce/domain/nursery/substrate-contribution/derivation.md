...
| OM2 datasheet                 | NOT yet in `nutrition/lettuce/domain/nursery/doc/` — refinement trigger pending      |
...
- **Berger OM2 datasheet pulled.** Drop PDF in `nutrition/lettuce/domain/nursery/doc/`,
...
| File                                                          | Owns                                                                                        |
|---------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| `nutrition/lettuce/domain/nursery/substrate-contribution/data.js`            | OM2 + feather meal constants, tray geometry, `LIMITS`                                       |
| `nutrition/lettuce/domain/nursery/substrate-contribution/calc.js`            | `theoreticalSubstrateReleasePerWeek(w, fmG)`, `cycleAverageReleasePerTray(fmG)`             |
| `nutrition/lettuce/domain/nursery/substrate-contribution/model.js`           | `window.SubstrateContributionNursery` namespace wrapper                                     |
| `nutrition/lettuce/domain/nursery/substrate-contribution/spec.md`            | Spec — what the model must do or be                                                         |
| `nutrition/lettuce/domain/nursery/substrate-contribution/derivation.md`      | This file                                                                                    |
| `nutrition/lettuce/domain/nursery/substrate-contribution/learnings.md`       | Rejected alternatives, historical decisions                                                  |
