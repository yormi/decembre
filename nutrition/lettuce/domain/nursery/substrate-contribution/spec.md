...
Out of scope: plant demand (`../plant-needs/`),
fertigation contribution (`../fertigation/`),
...
- **OM2 datasheet pull** — `OM2_STARTER_CHARGE_PPM` is cert 2 placeholder
  until Berger OM2 technical sheet lands in `nutrition/lettuce/domain/nursery/doc/`;
