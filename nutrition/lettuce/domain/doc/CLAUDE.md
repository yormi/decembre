# nutrition/lettuce/domain/doc — lettuce reference docs index
...
- Cross-referencing the lettuce fertigation recipe (`../../protocol/fertigation-recipe.md`) against measured soil-solution K / Mg / Na / sulfate.
...
⚠️ **SME spec min/max are soilless/hydroponic ranges — do not read them as soil deficiency thresholds.** The flagged-low P (1.7) especially: lead soil P reads with Mehlich-3 + tissue, not SME.
