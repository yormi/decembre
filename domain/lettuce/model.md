...
~4 wk in soil. EC + pH by 1:1 slurry — method `../../protocol/measure-ph-ec/bed-DRAFT.md`, sample top 0–5 cm. Salinity band below.
...
Measurement `../../protocol/measure-ph-ec/bed-DRAFT.md` (canonical, all crops). Lettuce = moderately salt-sensitive.
