...
_(Inbox empty. 2026-05-17 RGR refit closed sub-wave K — value-swap to 0.30 already shipped in W2 yield-range wave (commit `e8728f9`), this turn added the data.js anchor comment + integrator pin `REQ-115 — RGR refit pin: 50-cell / ledHours=16 / RGR=0.30 → daysToTransplantPotential = 44`; pruner stragglers all in audit-trail KEEP set per specialist's brief.)_
