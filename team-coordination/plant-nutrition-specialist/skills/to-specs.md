...
Philosophy in `team-coordination/lib/spec-discipline.md`. PO-side spec writing (cross-app, domain, PO surfaces) is the PO's — see `team-coordination/product-owner/skills/to-specs.md`.
...
See `team-coordination/lib/req-allocation.md`. Run with `<persona-name>` = `plant-nutrition-specialist`.
...
- `team-coordination/product-owner/skills/to-specs.md` — PO-surface counterpart
