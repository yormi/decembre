...
1. `team-coordination/model-challenger/drafts.md` — scan for `PENDING`
2. `team-coordination/plant-nutrition-specialist/from-model-challenger.md` — open requests previously approved
3. `team-coordination/plant-nutrition-specialist/from-model-challenger-done.md` — entries awaiting verdict
